...
public class CTMHelper
{
    ...
    private static boolean isPresent(IBlockAccess world, int x, int y, int z, int side, int location, Block block, int meta)
    {
        ...
        return (world.getBlock(x2, y2, z2).equals(block) && world.getBlockMetadata(x2, y2, z2) == meta) && (!world.getBlock(x2 + xOff, y2 + yOff, z2 + zOff).equals(block) && world.getBlockMetadata(x2, y2, z2) == meta);
    }
    ...
    public static int[] getSubmapInfo(IBlockAccess world, int x, int y, int z, int side)
    {
        ...
        int submap = (int) Math.floor(index / 16);
        int submapCordX = submapCords[index % 16][0];
        int submapCordY = submapCords[index % 16][1];

        return new int[] {submap, submapCordX, submapCordY};
    }
    ...
    public static enum Rotation
    {
        ...
        public static double[] rotateUV(Rotation rotation, double minU, double maxU, double minV, double maxV)
        {
